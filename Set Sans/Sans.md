...
Upgrade : 
- [ ] 1:Always wonder why people never use they're strongest attack first 
      sans teleport everyroine in a box and use is peak start attack
- [ ] 2 : Phase 2 : 
      20 stam but unlocvk phase 2
- [ ] 3 : Reduce stam usage on attack + unlock stressed on phase 2
...
Passive : 
	Lazyman : when sans doesn't move he gain more stam then other character that dont move
	Stressed : if you get under half your stam your attack will have slightly less CD
	Free bones : bones come from around the corridor trying to annoy chara team

Attack :
- [ ] 1:Bonerush:
	- [ ] Send a rush a bone at pretty fast Speed (this one contain extra Blue Bone)
	- [ ] variant : send bone from the sky falling from you to where you click
- [ ] 2 : Blaster 

--backup
Backboen : sans send bone to teh chara team member taht is the most aloen from teh other
